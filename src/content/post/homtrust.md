...
![a screen shot of Figjam showing needs](https://res.cloudinary.com/ddgt1wiwm/image/upload/f_auto,q_auto/v1/HT-figjam_iwc4sn)
 ...
 Traditional banking solutions weren't designed for short-term rental operators who need to manage trust accounts across multiple properties, handle frequent guest transactions, and maintain regulatory compliance. Out client needed a purpose-built solution that could handle the unique cash flow patterns and reporting requirements of STR property managers.
...
![a screenshot showing collaboration view](https://res.cloudinary.com/ddgt1wiwm/image/upload/f_auto,q_auto/v1/HT-design-role_tsm65d)
...
[Detailed case study](https://www.figma.com/deck/MKzDnRZudrt2xHi4XN5GPY/Andie-Yam-product-designer-2025---v2?node-id=1-55&viewport=-1142%2C-14633%2C0.48&t=h5aRhM24f5gqsmit-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1) 
